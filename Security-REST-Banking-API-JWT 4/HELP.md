...
* The original package name 'com.example.Security-REST-Banking-API-JWT ' is invalid and this project uses 'com.example.Security_REST_Banking_API_JWT' instead.
